...
const Navbar = () => {
  ...
  return (
    <header className="border-b border-base-300 fixed bg-base-100 top-0 z-40 w-full bg-base-100/80 backdrop-blur-lg">
        ...
        <div className="flex items-center justify-between h-full">
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-2.5 transition-all hover:opacity-80">
              ...
              <h1 className="text-lg font-bold">Convers</h1>
            </Link>
          </div>
